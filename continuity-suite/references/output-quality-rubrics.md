...
| Design | Incomplete-brief reassurance, inferred collaboration depth and specialization, inspected current state, announced research mode, decomposed references, private visual teaching evidence, structurally distinct comparable-fidelity concepts, numbered feedback and visual deltas, retained rejected choices, signature persistence, passed concept/prototype/implementation AI-slop reports, explicit tradeoffs and preservation, exact document/reference/bundle hashes, non-authorizing approval; presentation work additionally requires a narrative spine, at least four slide roles and silhouettes, one peak, one quiet or rest state, concept-forming media disposition, separately reviewed projected and read-ahead modes, format-verified individual captures, and slide-by-slide proof that all copy and data remains visible and readable; output-improvement claims additionally require blinded paired ratings of hash-bound baseline and candidate renders across project specificity, signature recognition, structural diversity, reference transformation, responsive fidelity, and genericity resistance |

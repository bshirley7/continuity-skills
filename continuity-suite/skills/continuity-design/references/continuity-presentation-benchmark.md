...
7. **Human selection.** Present concepts and pass history. Record only the human's explicit selection or combination. When the selection names concept-forming media as the reason, bind that media and its defining visual qualities as part of the decision.

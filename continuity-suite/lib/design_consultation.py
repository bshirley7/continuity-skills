...
CSS = r"""
:root{color-scheme:light;--paper:#f2f0e9;--ink:#111513;--muted:#56615c;--line:#b9c0ba;--signal:#17614d;--risk:#c46c24;--white:#fff}*{box-sizing:border-box}body{margin:0;background:var(--paper);color:var(--ink);font-family:ui-sans-serif,system-ui,sans-serif;font-size:16px;line-height:1.5}button,select,textarea{font:inherit;border:1px solid currentColor;background:var(--white);color:var(--ink)}button{padding:.8rem 1rem;cursor:pointer}button.primary{background:var(--ink);color:var(--white)}button:disabled{cursor:not-allowed;opacity:.62}button:focus-visible,select:focus-visible,textarea:focus-visible,input:focus-visible,figure:focus-visible,summary:focus-visible{outline:3px solid #ef9f35;outline-offset:3px}main{max-width:1800px;margin:auto;padding:clamp(1rem,3vw,3rem)}header{display:grid;grid-template-columns:minmax(0,1fr) minmax(20rem,.7fr);gap:clamp(1.25rem,3vw,3rem);padding-bottom:2rem;border-bottom:2px solid var(--ink)}header>div{min-width:0}h1{max-width:100%;font-family:Georgia,serif;font-size:clamp(2.6rem,5.5vw,5.6rem);font-weight:400;line-height:.96;letter-spacing:-.045em;margin:.15em 0;overflow-wrap:anywhere;hyphens:auto}.eyebrow{font:700 .72rem ui-monospace,monospace;letter-spacing:.14em;text-transform:uppercase}.lede{font-size:1.1rem;line-height:1.5;max-width:58ch}.notice{border-left:4px solid var(--signal);padding:1rem;background:var(--white)}.comparison-wrap{padding:2rem 0}.comparison-wrap>h2{font-family:Georgia,serif;font-size:clamp(2rem,4vw,4rem);font-weight:400;margin:.1rem 0}.comparison{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:1rem;margin-top:1.25rem}.comparison-card{background:var(--white);border-top:4px solid var(--ink);min-width:0}.comparison-card img{width:100%;height:clamp(18rem,42vw,42rem);object-fit:cover;object-position:top;border-bottom:1px solid var(--line)}.comparison-card div{padding:1rem}.comparison-card h3{font-family:Georgia,serif;font-size:1.65rem;font-weight:400;margin:.2rem 0}.concepts{display:grid;gap:3rem;margin:2rem 0}.concept{background:var(--white);border-top:6px solid var(--ink)}.concept-head{padding:clamp(1rem,2.5vw,2rem);display:grid;grid-template-columns:minmax(0,1fr) minmax(18rem,.65fr);gap:2rem}.concept h2{font-family:Georgia,serif;font-size:clamp(2.4rem,4vw,4.5rem);font-weight:400;line-height:1;margin:.2rem 0;overflow-wrap:anywhere}.meta{display:flex;flex-wrap:wrap;gap:.5rem;margin:1rem 0}.tag{font:700 .7rem ui-monospace,monospace;border:1px solid var(--ink);padding:.35rem .5rem}.remember{font-family:Georgia,serif;font-size:clamp(1.4rem,2.2vw,2.2rem);line-height:1.12;margin:0}.visuals{display:grid;grid-template-columns:minmax(0,1.7fr) repeat(2,minmax(14rem,.65fr));background:#cdd3ce;gap:1px}.visuals figure{margin:0;background:#d8ddd9;position:relative;min-width:0}.visuals figure:not(.overview){max-height:58rem;overflow:auto;overscroll-behavior:contain}.visuals img{display:block;width:100%;height:auto}.visuals .overview img{height:28rem;object-fit:cover;object-position:top}.visuals .overview.expanded img{height:auto}.visuals figcaption{position:absolute;bottom:.5rem;left:.5rem;max-width:calc(100% - 1rem);background:var(--ink);color:var(--white);padding:.4rem .55rem;font-size:.76rem}.evidence-toggle{position:absolute;right:.5rem;top:.5rem;background:var(--white);z-index:1}.concept-feedback{padding:1rem clamp(1rem,2.5vw,2rem);background:#eef0ec}.concept-feedback h3{margin:.3rem 0}.reaction{display:grid;grid-template-columns:minmax(12rem,.5fr) minmax(9rem,.25fr) minmax(18rem,1fr);gap:1rem;align-items:start;border-top:1px solid var(--line);padding:1rem 0}.reaction label{display:grid;gap:.35rem}.reaction select,.reaction textarea{width:100%;padding:.65rem}.reaction textarea{min-height:4.5rem}.detail{border-top:1px solid var(--line);padding:0 clamp(1rem,2.5vw,2rem) 1.5rem}.detail summary{cursor:pointer;font-weight:700;padding:1.1rem 0}.decision-grid,.guideline-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:1rem}.panel{border:1px solid var(--line);padding:1rem}.panel h3{margin-top:0}.panel ul{padding-left:1.25rem}.risk{border-left:4px solid var(--risk)}.safe{border-left:4px solid var(--signal)}.swatches{display:flex;flex-wrap:wrap;gap:.5rem}.swatch{border:1px solid var(--line);padding:.6rem;min-width:9rem}.chip{display:block;width:100%;height:2.5rem;border:1px solid var(--line);margin-bottom:.4rem}.feedback{background:#0f1512;color:#f5f5ef;padding:clamp(1rem,4vw,3rem);margin-top:3rem}.feedback h2{font-family:Georgia,serif;font-size:clamp(2rem,5vw,4rem);font-weight:400;margin-top:0}.feedback-extra{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:1rem}.feedback-extra label{display:grid;gap:.5rem}.feedback textarea,.feedback select{padding:.7rem}.iteration{margin-top:1rem}.actions{display:flex;flex-wrap:wrap;gap:.75rem;margin-top:1.25rem}.status{min-height:1.5rem;margin-top:1rem}.status.error{color:#ff9c83}.status.success{color:#8ee3b7}.quiet{color:var(--muted)}@media(max-width:1200px){.visuals{grid-template-columns:minmax(0,1.5fr) minmax(14rem,.7fr)}.visuals .overview{grid-column:1/-1}}@media(max-width:1050px){.comparison{grid-template-columns:1fr}.comparison-card{display:grid;grid-template-columns:1.4fr 1fr}.comparison-card img{height:30rem}.concept-head,.visuals,.decision-grid,.guideline-grid,.feedback-extra,.reaction{grid-template-columns:1fr}.visuals .overview{grid-column:auto}.visuals figure:not(.overview){max-height:44rem}}@media(max-width:600px){main{padding:.8rem}header,.comparison-card{display:block}header{padding-bottom:1.25rem}h1{font-size:clamp(2.15rem,12vw,3.5rem);line-height:1;letter-spacing:-.035em;margin-top:.25em}.comparison-card img{height:25rem}.concept-head{gap:.5rem}.visuals figure:not(.overview){max-height:none;overflow:visible}.visuals .overview img{height:22rem}.reaction textarea{min-height:6rem}.feedback{margin-left:-.8rem;margin-right:-.8rem}}@media(prefers-reduced-motion:reduce){*{scroll-behavior:auto!important;transition:none!important;animation:none!important}}
"""
...
const visuals=el('div',{class:'visuals'});for(const image of concept.images){const overview=image.role==='overview';const figure=el('figure',{class:overview?'overview':'',tabindex:'0','aria-label':`${image.label}. ${overview?'Use the expand control to inspect the complete evidence.':'Scroll to inspect the full evidence.'}`});figure.append(el('img',{src:image.src,alt:image.alt}),el('figcaption',{},image.label));if(overview){const toggle=el('button',{class:'evidence-toggle',type:'button','aria-expanded':'false'},'Expand complete evidence');toggle.addEventListener('click',()=>{const expanded=figure.classList.toggle('expanded');toggle.setAttribute('aria-expanded',String(expanded));toggle.textContent=expanded?'Collapse complete evidence':'Expand complete evidence'});figure.append(toggle)}visuals.append(figure)}article.append(visuals);
...
const render=data=>{snapshot=data;document.getElementById('title').textContent=data.title;document.getElementById('context').textContent=data.intent;document.getElementById('revision').textContent=`Design ${data.design_id} · revision ${data.revision}`;renderComparison(data);const concepts=document.getElementById('concepts');for(const [index,concept] of data.concepts.entries())concepts.append(renderConcept(concept,index));const preferred=document.getElementById('preferred');preferred.append(el('option',{value:''},'No preference yet'));for(const concept of data.concepts.filter(x=>x.direction_id))preferred.append(el('option',{value:concept.direction_id},concept.title));const submit=document.getElementById('submit');submit.disabled=!token;if(!token){submit.textContent='Direct submission unavailable';status.textContent='This is the static private board. Export feedback JSON and record it with Continuity.';status.className='status'}};
...
def _snapshot(root: Path, record: dict[str, Any], actor: str) -> tuple[dict[str, Any], dict[str, Path]]:
    ...
    for index, concept in enumerate(evidence["concepts"], 1):
        ...
        hash_images = []
        evidence_roles = [
            ("wide_composition", "Opening and primary composition", "opening"),
            ("narrow_transformation", "Responsive transformation", "responsive"),
        ]
        comparison = concept.get("comparison_coverage")
        if isinstance(comparison, dict) and isinstance(comparison.get("full_page_strip"), dict):
            evidence_roles.append(("full_page_strip", "Complete journey or sequence", "overview"))
        for key, label, role_name in evidence_roles:
            item = comparison["full_page_strip"] if key == "full_page_strip" else concept[key]
            ...
            images.append({"label": label, "alt": f"{title} — {label}", "role": role_name, "src": f"assets/{asset_name}"})
            asset_sources[asset_name] = path
            hash_images.append({"path": relative, "sha256": item["sha256"], "label": label, "role": role_name})
        normalized = {
        ...
        elements.extend([
            {"element_id": f"{index}.concept", "label": f"{index}.1 Overall direction: {title}"},
            {"element_id": f"{index}.carrier", "label": f"{index}.2 Memorable carrier: {concept['primary_carrier'].replace('-', ' ')}"},
            {"element_id": f"{index}.proof", "label": f"{index}.3 Product proof and authority handoff"},
            {"element_id": f"{index}.responsive", "label": f"{index}.4 Responsive transformation"},
        ])
        if concept.get("brand_guideline"):
            elements.append({"element_id": f"{index}.brand", "label": f"{index}.5 Brand system: color, typography, and application"})
